...
const Rating: React.FC = () => {
  const ratings = [
    ...
    { id: 5, name: 'David Kim', rating: 5, message: 'RyuuIzumi is a genius! This platform changed my approach to security testing.' },
    ...
    { id: 15, name: 'Kevin Martinez', rating: 5, message: 'RyuuIzumi created something truly special. This platform is fantastic!' },
    ...
    { id: 24, name: 'Ava Thompson', rating: 5, message: 'RyuuIzumi is a mastermind! This platform is incredible.' },
